...
class TestConfig:
    def test_settings_loading(self):
        ...
        # 验证默认配置
        assert tomorrow_settings.DEFAULT_MODEL == "qwen3.5:9b"
        # 允许从环境变量加载的不同 base_url
        assert tomorrow_settings.OLLAMA_BASE_URL.startswith("http")

    def test_settings_override_with_env(self):
        # 模拟环境变量覆盖
        with patch.dict(os.environ, {"TOMORROW_DEFAULT_MODEL": "gpt-4"}):
            ...
            assert new_settings.DEFAULT_MODEL == "gpt-4"
